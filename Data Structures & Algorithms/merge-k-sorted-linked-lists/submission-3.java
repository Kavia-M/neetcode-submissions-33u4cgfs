...
class Solution_min_of_each_round {
...
class Solution {
    // mergeTwoLists becomes conquer
    public static ListNode conquer(ListNode list1, ListNode list2) {
        // FROM PREVIOUS QUESTION 
        // list 1 should contain minimum
        if(list1 == null) return list2;
        if(list2 == null) return list1;
    ...
    private static ListNode divideAndConquer(ListNode lists[], int l, int r){
        if(l > r || lists==null) {
            // aray already completed
            // length = 0 means we get l=0 and r=-1
            return null;
        }
