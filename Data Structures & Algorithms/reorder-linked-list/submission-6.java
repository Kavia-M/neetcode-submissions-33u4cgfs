...
class Solution {
    ...
    public void reorderList(ListNode head) {
        ...
        // in case of odd number 1st half will have slow that is centre node

        // even number means slow is end of 1st half, 2nd have from slow.next will have equal nodes
        // if we need to find median or middle element always use fast as head.next
