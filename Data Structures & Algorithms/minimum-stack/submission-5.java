...
// add to min stack only if it minimum
    ...
    public void push(int val) {
        ...
        if(min_st.empty()) {
            ...
            if(val <= min_st.peek()) min_st.push(val); // less than or equal is used
            // because if there is more 5 5 5 where 5 is min, removing 1st 5 
            // in original stack removes it from min also causing wrong
        }
    }
