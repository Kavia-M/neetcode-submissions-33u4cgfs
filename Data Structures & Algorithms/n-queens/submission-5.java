...
class Solution {
    ...
    private void backtrack(int r, char[][] board) {
        ...
        for(int c=0; c<board[0].length; c++) {
            ...
            if(col.contains(c) || posDiag.contains(r+c) || negDiag.contains(c-r))
            ...
            negDiag.add(c-r); // this is the MAIN PRIMARY diagonal. here row and column both increases. So the difference R-C between row can column is maintained. r+1 - c+1 == r-c
