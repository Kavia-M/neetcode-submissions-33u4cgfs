...
class Solution {
    public List<Integer> preorderTraversal(TreeNode root) {
        ...
        while(curr != null) { // ensure we dont make leaf node's left or right (null) as curr
            ...
            if(curr.left == null) {
                // no left, curr already visited, move to right            
                ans.add(curr.val);
                ...
                // so we can confirm that the left is fully procressed, curr already added to ans, make this pedecessor's right to again null and move to curr's right
