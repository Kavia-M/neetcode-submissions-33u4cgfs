...
class Solution {
    ...
    private void backtrack(int ind, int[] nums) {
        ...
        // no need to do ind itself, because no point in swapping it with itself
        // but we need to use ind also so that ind+1 is called if ind is already nums.length-1, last index. then only base case recurrsion would be called
